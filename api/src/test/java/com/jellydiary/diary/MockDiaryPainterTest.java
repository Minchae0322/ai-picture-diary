...
import com.jellydiary.diary.infrastructure.ai.MockDiaryPainter;
...
class MockDiaryPainterTest {
    ...
    private static final DiaryProperties PROPERTIES =
            new DiaryProperties(
                    "Asia/Seoul",
                    new DiaryProperties.DiaryLimits(500, 3, -3, 3),
                    new DiaryProperties.Ai("mock", Duration.ZERO));

    private final MockDiaryPainter painter = new MockDiaryPainter(PROPERTIES);
